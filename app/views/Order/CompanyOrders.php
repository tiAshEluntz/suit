...
<body>
    ...
    <div class="py-5 text-center">
        <h2>Your Orders</h2>
        <p class="lead">A list of all of your orders.</p>
      </div>
...
$counter = 1;
  ...
  foreach($orders as $order){
      ...
      echo '<td><a class="btn btn-primary" href="/Order/EditOrder/' . $order->order_id . '">View Order</a> <a class="btn btn-danger" href="/Order/DeleteOrder/' . $order->order_id . '">Delete</a></td>';
      $counter++;
  }
